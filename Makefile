...
dist: main.c multithreaded_test.c garnish.c garnish.h garnish_M100_config.h garnish_S1000_config.h Makefile 2tables.c garnish_debug.h garnish_P100_config.h multiprocess_test.c README.md
...
main.o : main.c garnish_S1000.o garnish.h garnish_S1000_config.h
	$(CC) -include garnish_S1000_config.h $(CFLAGS) -c main.c -o $@
...
garnish_test: main.o garnish_S1000.o garnish.h garnish_S1000_config.h
	$(CC) -include garnish_S1000_config.h -include garnish.h $(CFLAGS) main.o garnish_S1000.o -o $@
...
clean:
	rm -f main.o multithreaded_test.o garnish.o libgarnish.a garnish_test garnish_multithreaded garnish_M100.o garnish_M100.h garnish_S1000.o garnish_S1000.h garnish_2tables garnish_P100.o garnish_P100.h garnish_multiprocess multiprocess_test.o
